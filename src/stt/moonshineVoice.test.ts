...
import { shutdownMoonshineVoicePool, transcribeAudio } from "./moonshineVoice";
...
if (!process.env.MOONSHINE_VOICE_TIMEOUT_SEC) {
  process.env.MOONSHINE_VOICE_TIMEOUT_SEC = timeoutSec;
}

after(() => {
  shutdownMoonshineVoicePool();
});
