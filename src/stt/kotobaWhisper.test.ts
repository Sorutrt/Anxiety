...
import { shutdownKotobaWhisperPool, transcribeAudio } from "./kotobaWhisper";
...
if (!process.env.KOTOBA_WHISPER_TIMEOUT_SEC) {
  process.env.KOTOBA_WHISPER_TIMEOUT_SEC = timeoutSec;
}
